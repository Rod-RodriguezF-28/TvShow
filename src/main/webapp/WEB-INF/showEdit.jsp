...
<div class="container">
    ...
    <h1 class="pt-3 pb-3">Edit show</h1>
    <form:form method="post" action="${pageContext.request.contextPath}/shows/${programa.id}/edit"
               modelAttribute="programa"
               class="w-50">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <form:input value="${programa.titulo}" path="titulo" type="text" class="form-control" id="titulo" name="titulo"/>
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <form:input value="${programa.network}" path="network" type="text" class="form-control" id="network" name="network"/>
            </div>
        ...
        <a class="btn btn-danger" href="/delete/${programa.id}">Delete</a>
    </form:form>
</div>
